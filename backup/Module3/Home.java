...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedCondition<WebElement> searchResult =
                    ExpectedConditions.visibilityOfElementLocated(By.xpath(
                            "//div[@class='MuiGrid-root MuiGrid-item MuiGrid-grid-xs-6 MuiGrid-grid-md-3 css-sycj1h']"));
            ExpectedCondition<WebElement> noProductFound = ExpectedConditions
                    .visibilityOfElementLocated(By.xpath("//h4[text()=' No products found ']"));
            wait.until(ExpectedConditions.or(searchResult, noProductFound));
            Thread.sleep(2000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             */
            List<WebElement> listOfProductTitles = driver.findElements(
                    By.xpath("//p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']"));

            List<WebElement> addToCartButtons = driver.findElements(By.xpath(
                    "//button[@class='MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium MuiButton-fullWidth MuiButtonBase-root card-button css-54wre3']"));
    ...
    public boolean switchToTab(Set<String> windows, int tabNo) {
        try {
            int count = 0;
