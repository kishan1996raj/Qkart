...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[contains(@class,'css-sycj1h')]//p[1]"), product),
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//*[contains(@class,'css-zgtx0t')]"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath("//*[contains(@class,'css-1gjj37g')]/div[1]")).getText().split("\n")[0]);
            }
